		...
		<div class="form-group">
			...
			if("Select".equalsIgnoreCase(it.jspTag)){
			   println dictUtil.getDictTemplate(column,"dict-updatePage-disp");
				...
				%>
				<textarea class="form-control j_editor"   name="${column.dataName}" id="${column.dataName}"  placeholder="请输入${column.cnname}"  style="min-height:250px;width:100%;">\$!{${varDomainName}.${it.dataName}}</textarea>
				<%
			 }
			else {%>
